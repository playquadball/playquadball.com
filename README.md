...
- **Anyone** wanting to understand this unique sport

## Content

All content is based on the official International Quadball Association (IQA) rulebook and has been fact-checked for accuracy.

## Development

Built with [MkDocs](https://mkdocs.org/) using the Material theme.
...
### Deployment
This site is designed for deployment on GitHub Pages or Cloudflare Pages:
```bash
mkdocs build
```
...
Official quadball rules are maintained by the International Quadball Association (IQA).